...
btntan = Button(screen, text='tan',font=('arial',15,'italic bold'),bd=8,padx=16,pady=19,command=cmtan,
                activebackground='green', activeforeground='white',bg='powder blue')
...
btnlog = Button(screen, text='log', font=('arial', 15, 'italic bold'), bd=8, padx=14, pady=19, command=cmlog,
                activebackground='green', activeforeground='white', bg='powder blue')
